    ...
    <section className="info-bout-me flex-horizontal-container">
     <div className="box-3">
      <div className="overlay-box round-behavior shadowed-element border-color-gray-2px">
       <div className="desc flex-vertical-container-raw justify-content-center align-items-center text-align-center">
        <h4>{t('programing')}!</h4>
        <h5>
      ...
      <div className="overlay-box round-behavior shadowed-element border-color-gray-2px">
       <div className="desc flex-vertical-container-raw justify-content-center align-items-center text-align-center">
        ...
        <h4 className="margin-5">
         {t('say')}
         <strong>{t('WarrenBuffett')}:</strong>
        </h4>
        <div className="flex-vertical-container-raw align-items-center text-align-center">
         <p className="flex-horizontal-container-raw border-color-bottom-gray padding-0">{t('rule')} №1:</p>
         {t('loseMoney')}.<p className=" border-color-bottom-gray padding-0">{t('rule')} №2:</p>
         <p>{t('forgetOne')} №1</p>
        </div>
       </div>
      </div>
     ...
     <div className="box-4">
      <div className="overlay-box round-behavior shadowed-element border-color-gray-2px">
       <div className="desc flex-vertical-container-raw justify-content-center align-items-center text-align-center">
        ...
        <h5 className="">
         {t('say')}
         <strong>{t('RobertKiyosaki')}:</strong>
        </h5>
        <span>
         <strong className="motivation border-color-bottom-gray ">"{t('motoRobert')}"</strong>
        </span>
       </div>
      </div>
     </div>
