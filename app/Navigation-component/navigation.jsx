...
import HamburgerMenu from "../HamburgerMenu-page/HamburgerMenuHTML";
...
const Navigation = () => {
    ...
    useEffect(() => {
        console.log("pesho",);
        setUserName(authUser?.username || session?.user?.name || "");
    }, []);
    ...
    return (
        <header
            ...
            {size.width < 501 ? (
                ...
                <div
                    className="maxWidthAndHeight justify-content-end flex-horizontal-container">
                    <div
