...
function NovatioApps(props) {
    ...
    const [shiftReception, setShiftReception] = useState(false); // new state
    let img = images;
    useEffect(() => {
    ...
    // helper to toggle by click or keyboard
    const toggleShiftReception = () => setShiftReception(true);
    const onKeyToggle = (e) => {
        if (e.key === 'Enter' || e.key === ' ') {
            e.preventDefault();
            toggleShiftReception();
        }
    };
    return (
                    ...
                    <div className="container-novatio-app flex-horizontal-container align-items-center justify-content-center">
                        <div className="flex-horizontal-container mobile-novatio-apps">
                            <div className="card margin-15"
                                 role="button"
                                 tabIndex={0}
                                 onClick={toggleShiftReception}            // click toggles shift
                                 onKeyDown={onKeyToggle}                    // keyboard accessible
                                 style={{ cursor: 'pointer' }}
                                 aria-pressed={shiftReception}
                            >
                            ...
                            <div className={`card margin-15 ${shiftReception ? 'mb-important' : ''}`}
                            >
                                <div className="img-box">
