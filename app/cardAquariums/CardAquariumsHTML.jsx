              ...
              <div className="blog-card margin-15" key={index}>
               <div className="meta">
                ...
                <ul className="details">
                 ...
                 <li className="tags">
                  <ul>
                   <li className="support-fish-aquarium">{t('Support')}</li>,<li className="support-fish">{t('Fish')}</li>,<li className="support-aquarium">{t('Aquarium')}</li>
                  </ul>
                 </li>
                </ul>
               </div>
               <div className="description">
                <h1>{article.title}</h1>
                <h5>Вашето ръководство за създаване и поддръжка на здрав и красив аквариум.</h5>
                {index === 0 ? <span>Аквариумите не са просто декорация, а живи екосистеми, които внасят спокойствие и красота в дома. Те обаче изискват знания, внимание и грижи. Ако мечтаете за аквариум, но не знаете откъде да започнете, тази статия ще ви даде основни насоки.</span> : <span>{article.sections[index - 1].content.substring(0, 220)}...</span>}
