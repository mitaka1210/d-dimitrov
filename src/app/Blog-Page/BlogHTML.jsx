        ...
        <div className="blog-main-container">
            <div className="min-h-screen bg-white grid place-content-center p-5">
                ...
                <div className="grid lg:grid-cols-3 gap-7 justify-center">
                    <div
                        className={`max-w-sm shadow-xl relative card rounded-md overflow-hidden${
                            blockCategoryAquariums ? "" : " opacity-50 cursor-not-allowed"
                        }`}
                    ...
                    >
                        <div className="relative">
                            <img
                                ...
                                alt=""
                                className="max-w-full add-img-height"
                            />
